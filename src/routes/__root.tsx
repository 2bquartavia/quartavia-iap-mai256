...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Alavanca Patrimonial : QuartaVia" },
      { name: "description", content: "5 encontros pra você sair do improviso financeiro e entrar num plano real de construção de patrimônio — usando alavancagem, crédito inteligente e os ativos cert" },
      { name: "author", content: "Aurum Capital" },
      { property: "og:title", content: "Alavanca Patrimonial : QuartaVia" },
      { property: "og:description", content: "5 encontros pra você sair do improviso financeiro e entrar num plano real de construção de patrimônio — usando alavancagem, crédito inteligente e os ativos cert" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Alavanca Patrimonial : QuartaVia" },
      { name: "twitter:description", content: "5 encontros pra você sair do improviso financeiro e entrar num plano real de construção de patrimônio — usando alavancagem, crédito inteligente e os ativos cert" },
